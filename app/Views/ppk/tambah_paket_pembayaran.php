...
<div class="card-body">
    <form action="<?= base_url('paket/tambah_data_paket_pembayaran') ?>" method="post" onsubmit="return validateForm()">
...
<script>
    function validateForm() {
        let fields = ["tahun_anggaran", "dipa", "nama_penyedia", "kode_dokumen", "kode_sp2d", "total_pembayaran", "pdn"];
